...
const LISTS = {
  ...
  want: ["The Studio","Dope Thief","Mad Max: Fury Road","Sonne und Beton","Lady Bird","Ripley","Arrival","Poor Things","Split","Justified","Fair Play","Undercover","Ferry: Die Serie","Babylon","Ford v Ferrari","Reptile","The Card Counter","Memories of Murder","The Wire","Peaky Blinders","Foundation","Pachinko","Mare of Easttown","Daisy Jones & The Six","Ferrari","The Bear","Ted Lasso","Bad Sisters","For All Mankind","Severance","Kaos","Ginny & Georgia","Skins","Dopesick","Maid","True Story","Borgen","Black Bird","Cherry","Home Before Dark","Perfekt verpasst","Land of Bad","The Night Manager","My Name","Apple Cider Vinegar","Zero Day","Trauma Code","Absolution","Remarriage & Desires","His & Hers","The Rip","Ein letztes Abenteuer","Abbott Elementary","Hamilton","English Teacher","Rivals","Shifting Gears","Wonder Man","The Beauty","Deli Boys","Palmer","Krank Berlin","The Savant","Firebug","Neuromancer","Fountain of Youth"],
